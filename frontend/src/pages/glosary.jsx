      ...
      <div id="glosario-selector" className="flex flex-wrap gap-2 mb-4">
        {secciones.map((s) => (
          <Button
            ...
            className="hover:bg-gray-200 dark:text-white dark:bg-black/20 dark:hover:bg-gray-700 dark:border-gray-600 rounded transition-all duration-300 hover:shadow-md hover:scale-105"
          >
            {s.label}
          </Button>
        ))}
