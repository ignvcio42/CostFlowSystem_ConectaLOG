    ...
    <div className="w-full flex items-center justify-between py-6">
      <Link to="/">
        <div className="flex items-center gap-2 cursor-pointer">
          <div className="w-10 md:w-12 h-10 md:h-12 flex items-center justify-center bg-violet-700 rounded-xl hover:bg-red-600 dark:bg-red-500 dark:hover:bg-yellow-300">
            <FaTruckPlane className="text-white text-3xl hover:animate-spin" />
          </div>
